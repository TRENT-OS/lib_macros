...
#define TEST_DEV_INVALID(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_DEVICE_INVALID, _fn_)
#define TEST_DEV_NOT_PRESENT(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_DEVICE_NOT_PRESENT, _fn_)
#define TEST_DEV_BUSY(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_DEVICE_BUSY,  _fn_)
// Check CONFIG specific return codes
#define TEST_CFG_PARAM_NOT_FOUND(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_CONFIG_PARAMETER_NOT_FOUND, _fn_)
// Check GENERIC return codes
#define TEST_BUF_FULL(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_BUFFER_FULL, _fn_)
#define TEST_BUF_EMPTY(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_BUFFER_EMPTY, _fn_)
#define TEST_NO_DATA(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_NO_DATA, _fn_)
#define TEST_NOT_INIT(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_NOT_INITIALIZED, _fn_)
#define TEST_TRY_AGAIN(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_TRY_AGAIN, _fn_)
#define TEST_WOULD_BLOCK(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_WOULD_BLOCK, _fn_)
#define TEST_OOBOUNDS(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_OUT_OF_BOUNDS, _fn_)
#define TEST_CONN_CLOSED(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_CONNECTION_CLOSED, _fn_)
#define TEST_OVERFLOW(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_OVERFLOW_DETECTED, _fn_)
#define TEST_INSUFF_SPACE(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_INSUFFICIENT_SPACE, _fn_)
#define TEST_TOO_SMALL(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_BUFFER_TOO_SMALL, _fn_)
#define TEST_ABORTED(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_ABORTED, _fn_)
#define TEST_OP_DENIED(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_OPERATION_DENIED, _fn_)
#define TEST_ACC_DENIED(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_ACCESS_DENIED, _fn_)
#define TEST_NOT_FOUND(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_NOT_FOUND, _fn_)
#define TEST_INVAL_HANDLE(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_INVALID_HANDLE, _fn_)
#define TEST_INVAL_NAME(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_INVALID_NAME, _fn_)
#define TEST_INVAL_PARAM(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_INVALID_PARAMETER, _fn_)
#define TEST_INVAL_STATE(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_INVALID_STATE, _fn_)
#define TEST_NOT_SUPP(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_NOT_SUPPORTED, _fn_)
#define TEST_NOT_IMPL(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_NOT_IMPLEMENTED, _fn_)
#define TEST_GENERIC(_fn_) \
    ASSERT_EQ_OS_ERR(OS_ERROR_GENERIC, _fn_)
#define TEST_SUCCESS(_fn_) \
    ASSERT_EQ_OS_ERR(OS_SUCCESS, _fn_)
///@}
